...
void view_issued_book(char *u_id)
{
    int i, days_left;
    BOOK book;
    ISSUE us; 
    ...
    issfile = fopen("../bin/issues.txt", "r+"); //"../Issues/issues.txt", "r+" need to use in main
    bkfile = fopen("../bin/books.txt", "r+"); //"../BooksDB/books.txt", "r+" need to use in main
